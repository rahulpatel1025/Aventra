...
export default function Courses() {
  ...
  // Fetch all published courses from backend (includes OData + FinTech)
  useEffect(() => {
    ...
    <>
          ...
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-7">
              <div className="what-you-get-card bento-card">
                <h2 style={{ fontSize: "28px", letterSpacing: "-0.03em" }}>
                  What You Get
                </h2>
      ...
      <div className="container-xxl py-5">
        <div className="container">
          ...
          {/* COURSE GRID — all courses from MongoDB rendered uniformly */}
          <div className="row g-4 justify-content-center align-items-stretch">
            ...
            {/* AI/ML course card — still hardcoded until added to MongoDB */}
            {!loading && (
